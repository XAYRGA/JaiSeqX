...
{
    class JAIV1_AAFLoader
    {
        public JWaveSystem[] WSYS;
        public JIBank[] IBNK;
        ...
        public void load(ref byte[] data)
        {
            WSYS = new JWaveSystem[0xFF]; // None over 256 please :).
            IBNK = new JIBank[0xFF]; // These either. 
            ...
            while (!done)
            {
                ...
                {
                    case 0:
                        done = true; // either we're misalligned or done, so just stop here. 
                        break;
                    case 1: // Don't know 
                    case 5:
                    case 4:
                    ...
                    case 3: // WSYS 
                        {
                            while (true)
                            {
                                ...
                                if (ChunkID == 3)
                                {
                                    ...
                                    var b = new JWaveSystem(); // Load the wavesystem
                                    b.LoadWSYS(aafRead);
